...
class Payment {
    ...
    public function prepareCustomFormTemplate ($formData) {
        ...
        $htmlEntity = '<form  action="'.$formData["gateway_url"].'" method="post" name="server_request" target="_top" >
                <table width="80%" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr><td><input type="hidden" name="encrypted_request" id="encrypted_request" value="'.$formData['encrypted_request'].'" /></td>
                    </tr><tr><td><input type="hidden" name="merchant_id" id="merchant_id" value="'.$formData['merchant_id'].'" /></td>
                    </tr><tr><td><input type="hidden" name="access_token" id="access_token" value="'.$formData['access_token'].'"></td>
                    </tr></table></form>';
        return $htmlEntity;
    }
